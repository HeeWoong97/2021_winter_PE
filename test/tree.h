...
void fix_up_case1_r(tree_node *x, tree_node *w, vector *nodes_own_flag, long thread_index); // mirror case
void fix_up_case3_r(tree_node *x, tree_node *w, vector *nodes_own_flag); // mirror case
